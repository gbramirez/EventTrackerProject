...
START TRANSACTION;
USE `pregnancydb`;
INSERT INTO `pregnancy` (`id`, `weeks`, `milestones`, `due_date`) VALUES (1, 1, 'Morning sickness', NULL);
INSERT INTO `pregnancy` (`id`, `weeks`, `milestones`, `due_date`) VALUES (2, 2, 'More sickness', NULL);
INSERT INTO `pregnancy` (`id`, `weeks`, `milestones`, `due_date`) VALUES (3, 3, 'Even more sickness', NULL);
INSERT INTO `pregnancy` (`id`, `weeks`, `milestones`, `due_date`) VALUES (4, 4, 'Positive pregnancy test', NULL);
